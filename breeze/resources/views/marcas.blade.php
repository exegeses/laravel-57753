    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                {{-- contenido --}}
                    ...
                    @if ( session('mensaje') )
                        <div class="max-w-2xl mx-auto m-12 p-3 mb-4
                            border border-{{ session('css') }}-300 bg-{{ session('css') }}-100 text-{{ session('css') }}-600 rounded">
            ...
            @foreach( $marcas as $marca )
                            ...
                            <div class="border-b border-gray-100 p-3 flex items-center justify-center">
                                                <span class="w-1/4 mx-2">
                            <a href="/marca/confirm/{{ $marca->idMarca }}" class="text-yellow-600 hover:text-yellow-500
                                        bg-gray-50 hover:bg-white px-5 py-1
                                        border border-gray-300 rounded
                                        ">Eliminar</a>
                        </span>
